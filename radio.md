---
layout: layout.njk
title: AiChemy for Audio | Custom Music for Broadcasters
---
...
<div class="container">
  ...
  <section style="margin-bottom: 5rem;">
    ...
    <div style="background: linear-gradient(to bottom, #f8f9fa 0%, #ffffff 100%); padding: 3rem; border-radius: 16px; text-align: center; border: 3px solid #5548a0; box-shadow: 0 8px 32px rgba(102, 126, 234, 0.15);">
      <p style="font-size: 1.4rem; color: #5548a0; margin: 0 0 2rem 0; font-weight: 700;">🎧 Listen Now</p>
      ...
      <div style="margin-top: 2rem; padding: 2rem; background: linear-gradient(135deg, #5548a0 0%, #4a3a99 100%); border-radius: 12px; box-shadow: 0 4px 16px rgba(102, 126, 234, 0.2);">
  ...
  <section style="margin-bottom: 5rem;">
    ...
    <div style="background: linear-gradient(to bottom, #f8f9fa 0%, #ffffff 100%); padding: 2.5rem; border-radius: 12px; border-left: 6px solid #5548a0; box-shadow: 0 4px 16px rgba(0,0,0,0.08);">
  ...
  <section style="margin-bottom: 5rem;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(340px, 1fr)); gap: 2.5rem;">
      ...
      <div style="background: linear-gradient(to bottom, #ffffff 0%, #f8f9fa 100%); border: 3px solid #5548a0; padding: 3rem; border-radius: 16px; box-shadow: 0 8px 32px rgba(102, 126, 234, 0.2); transition: transform 0.3s ease;">
        <div style="background: linear-gradient(135deg, #5548a0 0%, #4a3a99 100%); color: white; padding: 0.75rem 1.5rem; border-radius: 8px; display: inline-block; margin-bottom: 1.5rem; font-weight: 700; box-shadow: 0 4px 12px rgba(102, 126, 234, 0.3);">
          <strong>SINGLE TRACK</strong>
        </div>
        
        <h3 style="color: #5548a0; margin-bottom: 1rem; font-size: 1.75rem;">One-Off Special</h3>
        ...
        <a href="mailto:will@tctcusa.com?subject=Radio Single Track Inquiry" class="form-button" style="display: block; text-align: center; background: linear-gradient(135deg, #5548a0 0%, #4a3a99 100%); color: white; padding: 1rem 2rem; font-weight: 700; font-size: 1.1rem; box-shadow: 0 4px 16px rgba(102, 126, 234, 0.3);">Get Started</a>
      </div>
      ...
      <div style="background: linear-gradient(to bottom, #ffffff 0%, #f8f9fa 100%); border: 4px solid #f6c042; padding: 3rem; border-radius: 16px; box-shadow: 0 12px 48px rgba(246, 192, 66, 0.35); transform: scale(1.05); position: relative; overflow: hidden;">
        ...
        <h3 style="color: #5548a0; margin-bottom: 1rem; font-size: 1.85rem;">Show Package</h3>
      ...
      <div style="background: linear-gradient(135deg, #0a0e27 0%, #5548a0 100%); border: 3px solid #f6c042; padding: 3rem; border-radius: 16px; color: white; box-shadow: 0 10px 40px rgba(246, 192, 66, 0.35);">
  ...
  <section style="margin-bottom: 5rem;">
    ...
    <div style="max-width: 1100px; margin: 0 auto;">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 2.5rem;">
        <div style="background: linear-gradient(to bottom, #ffffff 0%, #f8f9fa 100%); padding: 2.5rem; border-radius: 16px; border: 3px solid #5548a0; box-shadow: 0 8px 32px rgba(102, 126, 234, 0.15);">
          <h3 style="color: #5548a0; margin-bottom: 1.5rem; font-size: 1.5rem;">📻 Morning Show Bits</h3>
          <ul style="line-height: 2; color: #2c3e50; font-size: 1.05rem;">
            ...
            <li>Local celebration songs</li>
          </ul>
        </div>
        
        <div style="background: linear-gradient(to bottom, #ffffff 0%, #f8f9fa 100%); padding: 2.5rem; border-radius: 16px; border: 3px solid #5548a0; box-shadow: 0 8px 32px rgba(102, 126, 234, 0.15);">
          <h3 style="color: #5548a0; margin-bottom: 1.5rem; font-size: 1.5rem;">🎵 Station Branding</h3>
          <ul style="line-height: 2; color: #2c3e50; font-size: 1.05rem;">
            <li>Station IDs & jingles</li>
            <li>Segment intros/outros</li>
            <li>Transition music</li>
            <li>Weather & traffic beds</li>
        ...
        <div style="background: linear-gradient(to bottom, #ffffff 0%, #f8f9fa 100%); padding: 2.5rem; border-radius: 16px; border: 3px solid #f6c042; box-shadow: 0 8px 32px rgba(246, 192, 66, 0.2);">
          ...
          <ul style="line-height: 2; color: #2c3e50; font-size: 1.05rem;">
            ...
            <li>Product launch themes</li>
            <li>Memorable hooks</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div style="max-width: 900px; margin: 0 auto;">
      ...
      <div style="display: grid; gap: 2rem;">
        <div style="background: white; padding: 2rem; border-radius: 12px; border-left: 6px solid #5548a0; box-shadow: 0 4px 16px rgba(0,0,0,0.06);">
          <p style="margin: 0; font-size: 1.1rem; color: #2c3e50; line-height: 1.8;"><strong style="color: #5548a0; font-size: 1.15rem;">Lightning Fast:</strong> 48-hour turnaround for most tracks (24-hour rush available)</p>
        </div>
        
        <div style="background: white; padding: 2rem; border-radius: 12px; border-left: 6px solid #5548a0; box-shadow: 0 4px 16px rgba(0,0,0,0.06);">
          <p style="margin: 0; font-size: 1.1rem; color: #2c3e50; line-height: 1.8;"><strong style="color: #5548a0; font-size: 1.15rem;">Radio Quality:</strong> Professional-grade output ready for broadcast</p>
        </div>
        ...
        <div style="background: white; padding: 2rem; border-radius: 12px; border-left: 6px solid #5548a0; box-shadow: 0 4px 16px rgba(0,0,0,0.06);">
          <p style="margin: 0; font-size: 1.1rem; color: #2c3e50; line-height: 1.8;"><strong style="color: #5548a0; font-size: 1.15rem;">Unlimited Revisions:</strong> We iterate until it's perfect for your show</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="margin-bottom: 5rem;">
    <div style="background: linear-gradient(135deg, #0a0e27 0%, #5548a0 100%); color: white; padding: 4rem 2.5rem; border-radius: 16px; text-align: center; max-width: 900px; margin: 0 auto; box-shadow: 0 12px 48px rgba(10, 14, 39, 0.35); border: 2px solid rgba(246, 192, 66, 0.2);">
      ...
      <div style="background: rgba(255,255,255,0.15); padding: 2.5rem; border-radius: 12px; margin-bottom: 3rem; border: 2px solid rgba(255,255,255,0.2); backdrop-filter: blur(10px);">
        ...
        <ol style="text-align: left; max-width: 550px; margin: 0 auto; line-height: 2; font-size: 1.1rem; color: white;">
          ...
          <li>You provide feedback</li>
          <li>Deliver final files in 48-72 hours</li>
        </ol>
      </div>
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 1.5rem; justify-content: center; margin-bottom: 2.5rem;">
        ...
        <a href="{{ '/creative/' | url }}" style="display: inline-block; padding: 1.25rem 2.5rem; background: white; color: #5548a0; text-decoration: none; border-radius: 12px; font-weight: 700; font-size: 1.15rem; box-shadow: 0 4px 16px rgba(255,255,255,0.3);">See All Music Services</a>
      </div>
  ...
  <section style="text-align: center; padding: 3rem 2rem; margin-bottom: 3rem;">
    <p style="font-style: italic; color: #2c3e50; font-size: 1.2rem; font-weight: 500;">
      <strong style="color: #5548a0;">AiChemy for Audio:</strong> Where radio meets artificial intelligence, creativity meets speed
    </p>
  </section>
  ...
  <section style="text-align: center; padding: 4rem 2.5rem; background: linear-gradient(to bottom, #f8f9fa 0%, #ffffff 100%); border-radius: 16px; box-shadow: 0 8px 32px rgba(0,0,0,0.08); border: 2px solid rgba(102, 126, 234, 0.1);">
    ...
    <div style="display: flex; justify-content: center; gap: 1.5rem; flex-wrap: wrap; margin-bottom: 3rem;">
      <a href="{{ '/software/' | url }}" class="form-button" style="background: linear-gradient(135deg, #5548a0 0%, #4a3a99 100%); color: white; padding: 1rem 2rem; font-size: 1.1rem; font-weight: 700; box-shadow: 0 4px 16px rgba(102, 126, 234, 0.3);">Browse Software</a>
      ...
      <a href="{{ '/packages/' | url }}" class="form-button" style="background: linear-gradient(135deg, #5548a0 0%, #4a3a99 100%); color: white; padding: 1rem 2rem; font-size: 1.1rem; font-weight: 700; box-shadow: 0 4px 16px rgba(102, 126, 234, 0.3);">See Bundles</a>
    </div>
    ...
    <div style="background: white; padding: 2rem; border-radius: 12px; max-width: 600px; margin: 0 auto 2.5rem auto; box-shadow: 0 4px 16px rgba(0,0,0,0.06); border: 2px solid rgba(102, 126, 234, 0.1);">
      ...
      <p style="margin: 0.5rem 0; color: #2c3e50; font-size: 1.05rem;"><strong style="color: #0a0e27;">Email:</strong> <a href="mailto:will@tctcusa.com" style="color: #5548a0; text-decoration: none; font-weight: 600;">will@tctcusa.com</a></p>
      <p style="margin: 0.5rem 0; color: #2c3e50; font-size: 1.05rem;"><strong style="color: #0a0e27;">Phone/Text:</strong> <a href="tel:8592678383" style="color: #5548a0; text-decoration: none; font-weight: 600;">(859) 267-8383</a></p>
    </div>
    
    <p style="margin-top: 2rem; font-size: 1.4rem; color: #5548a0; font-weight: 700;">
